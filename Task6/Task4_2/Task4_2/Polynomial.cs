...
namespace Task4_2
{
    class Polynomial
    {
        ...
        public static Polynomial operator +(Polynomial polynomial1, Polynomial polynomial2)
        {
            ...
            {
                orderNumber = polynomial2.monomials[i].Order;
                for (int j = 0; j < polynomial1.monomials.Length; ++j)
                {
                    if (orderNumber == polynomial1.monomials[j].Order)
                    {
                        orderNumber = -1;
                        break;
                    }
            ...
            polynomial.monomials = new Monomial[polynomial1.monomials.Length + uniqueOrders];
            for (int i = 0; i < polynomial1.monomials.Length; ++i)
            {
            ...
            int nonZeroOrdersElementsCount = polynomial1.monomials.Length;
            ...
            for (int i = 0; i < polynomial2.monomials.Length; ++i)
            {
                ...
                for (int j = 0; j < polynomial1.monomials.Length; ++j)
                {
                    if ((polynomial2.monomials[i].Order == polynomial1.monomials[j].Order) && (thisDeletedIndexMonomial < 0) && (otherDeletedIndexMonomial < 0))
                    {
                        if ((polynomial1.monomials[j].C + polynomial2.monomials[i].C) == 0)
                        {
                        ...
                        {
                            polynomial.monomials[j].C = polynomial1.monomials[j].C + polynomial2.monomials[i].C;
                            uniqueOrderNumber = false;
                            break;
                        }
                    }
                ...
                {
                    polynomial.monomials[nonZeroOrdersElementsCount] = polynomial2.monomials[i].Copy();
                    ++nonZeroOrdersElementsCount;
                }
            }
            return polynomial;
