...
namespace Task9
{
    ...
    class Meat : Product
    {
        ...
        {
            return $"Name: {Name}, price = {Price} grn, weight = {Weight}g, expiration date: {ExpirationDate} days, creation date: {CreationDate}, category: {CategoryOfMeat}, kind of meat: {KindOfMeat}";
        }
